...
1) Step 1: Synthetic question generation using DeepSeek-V3.2 API. Requires manual review of question qualities.
2) Step 2: Feed and extract responses from SMC or other models for evaluation
3) Step 3: Evaluate the generated outputs for:
