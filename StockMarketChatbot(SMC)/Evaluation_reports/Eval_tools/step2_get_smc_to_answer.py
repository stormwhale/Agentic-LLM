...
#====================================
df_screened = pd.read_json('generated_questions/deepeval_questions1.json')
...
if model_selection == "qwen":
    ...
    df_screened.to_json(f'generated_answers/test_question1_filled_{model_selection}_{timestamp}.json', orient='records', indent=2)
    print(f'Success! {model_selection} answered all questions.Check the generated_answers folder for the results.')
